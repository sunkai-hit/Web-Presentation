...
|---|---|---:|---|---|
| 数智健康 OPC 国际人才社区 | `opc-talent-community` | `v0.4.1` | Released / Migration validated | `projects/opc-talent-community/` |
...
- `QA`：质量检查与修订中
- `Released`：已有稳定发布版本
- `Released / Migration validated`：稳定版本已发布，多项目仓库迁移、公共工具链与参数化 Actions 已通过回归，等待旧根目录清理
- `Archived`：归档，仅保留历史版本
